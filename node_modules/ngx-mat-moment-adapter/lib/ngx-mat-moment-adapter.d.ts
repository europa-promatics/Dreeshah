...
export declare const MAT_MOMENT_DATE_ADAPTER_OPTIONS: InjectionToken<NgxMatMomentDateAdapterOptions>;
/** @docs-private */
export declare function MAT_MOMENT_DATE_ADAPTER_OPTIONS_FACTORY(): NgxMatMomentDateAdapterOptions;
