...
var NguiAutoCompleteComponent = (function () {
    ...
    NguiAutoCompleteComponent.prototype.subscribeToSourceChanges = function () {
        var _this = this;
        this.sourceChanges.subscribe(function (value) {
            _this.source = value;
            _this.reloadList(_this.lastKeyword);
        });
    };
    __decorate([
    ...
    __decorate([
        core_1.Input("source-changes"), 
        __metadata('design:type', core_1.EventEmitter)
    ], NguiAutoCompleteComponent.prototype, "sourceChanges", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
...
var NguiAutoCompleteDirective = (function () {
    function NguiAutoCompleteDirective(resolver, renderer, viewContainerRef, parentForm) {
        ...
        this.sourceChanges = new core_1.EventEmitter();
        ...
        this.showAutoCompleteDropdown = function (event) {
            ...
            component.sourceChanges = _this.sourceChanges;
