(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material/form-field'), require('@angular/forms'), require('libphonenumber-js'), require('@angular/cdk/coercion'), require('rxjs'), require('@angular/cdk/a11y'), require('@angular/material/core'), require('@angular/material/menu'), require('@angular/common'), require('@angular/material/input'), require('@angular/material/button'), require('@angular/material/divider')) :
    typeof define === 'function' && define.amd ? define('ngx-mat-intl-tel-input', ['exports', '@angular/core', '@angular/material/form-field', '@angular/forms', 'libphonenumber-js', '@angular/cdk/coercion', 'rxjs', '@angular/cdk/a11y', '@angular/material/core', '@angular/material/menu', '@angular/common', '@angular/material/input', '@angular/material/button', '@angular/material/divider'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-mat-intl-tel-input'] = {}, global.ng.core, global.ng.material.formField, global.ng.forms, global.libphonenumberJs, global.ng.cdk.coercion, global.rxjs, global.ng.cdk.a11y, global.ng.material.core, global.ng.material.menu, global.ng.common, global.ng.material.input, global.ng.material.button, global.ng.material.divider));
}(this, (function (exports, i0, formField, forms, libphonenumberJs, coercion, rxjs, a11y, core, menu, common, input, button, divider) { 'use strict';
    ...
    NgxMatIntlTelInputService.ɵprov = i0.ɵɵdefineInjectable({ factory: function NgxMatIntlTelInputService_Factory() { return new NgxMatIntlTelInputService(); }, token: NgxMatIntlTelInputService, providedIn: "root" });
    NgxMatIntlTelInputService.decorators = [
        { type: i0.Injectable, args: [{
                    providedIn: 'root'
                },] }
    ];
    NgxMatIntlTelInputService.ctorParameters = function () { return []; };
    ...
    ***************************************************************************** */
    ...
    // tslint:disable-next-line:variable-name
    var _NgxMatIntlTelInputMixinBase = core.mixinErrorState(NgxMatIntlTelInputBase);
    var ɵ0 = phoneNumberValidator;
    var NgxMatIntlTelInputComponent = /** @class */ (function (_super) {
        __extends(NgxMatIntlTelInputComponent, _super);
        function NgxMatIntlTelInputComponent(_changeDetectorRef, countryCodeData, fm, elRef, ngControl, 
        // tslint:disable-next-line:variable-name
        _parentForm, 
        // tslint:disable-next-line:variable-name
        _parentFormGroup, 
        ...
        _defaultErrorStateMatcher) {
            ...
            _this.focused = false;
            _this.id = "ngx-mat-intl-tel-input-" + NgxMatIntlTelInputComponent.nextId++;
            _this.describedBy = '';
            _this.phoneNumber = '';
            _this.allCountries = [];
        ...
        Object.defineProperty(NgxMatIntlTelInputComponent.prototype, "format", {
            get: function () {
                return this._format;
            },
            set: function (value) {
        ...
        NgxMatIntlTelInputComponent.prototype.getCountry = function (code) {
        ...
        Object.defineProperty(NgxMatIntlTelInputComponent.prototype, "formattedPhoneNumber", {
            get: function () {
                if (!this.numberInstance) {
        ...
        NgxMatIntlTelInputComponent.prototype.formatAsYouTypeIfEnabled = function () {
    ...
    NgxMatIntlTelInputComponent.decorators = [
        { type: i0.Component, args: [{
                    ...
                    providers: [
                        CountryCode,
                        { provide: formField.MatFormFieldControl, useExisting: NgxMatIntlTelInputComponent },
                        {
    ...
    NgxMatIntlTelInputComponent.propDecorators = {
        ...
        matMenu: [{ type: i0.ViewChild, args: [menu.MatMenu,] }],
        id: [{ type: i0.HostBinding }],
        countryChanged: [{ type: i0.Output }],
        shouldLabelFloat: [{ type: i0.HostBinding, args: ['class.ngx-floating',] }],
    ...
    NgxMatIntlTelInputModule.decorators = [
...
//# sourceMappingURL=ngx-mat-intl-tel-input.umd.js.map
