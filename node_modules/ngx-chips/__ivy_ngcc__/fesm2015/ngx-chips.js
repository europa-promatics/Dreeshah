...
function TagComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r281.editing);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(3, _c1, ctx_r281.model, ctx_r281.index))("ngTemplateOutlet", ctx_r281.template);
} }
function TagComponent_div_2_delete_icon_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function TagComponent_div_2_delete_icon_3_Template_delete_icon_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r287); const ctx_r286 = ɵngcc0.ɵɵnextContext(2); return ctx_r286.remove($event); });
    ɵngcc0.ɵɵelementEnd();
} }
function TagComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown.enter", function TagComponent_div_2_Template_div_keydown_enter_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r289); const ctx_r288 = ɵngcc0.ɵɵnextContext(); return ctx_r288.disableEditMode($event); })("keydown.escape", function TagComponent_div_2_Template_div_keydown_escape_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r289); const ctx_r290 = ɵngcc0.ɵɵnextContext(); return ctx_r290.disableEditMode($event); })("click", function TagComponent_div_2_Template_div_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r289); const ctx_r291 = ɵngcc0.ɵɵnextContext(); return ctx_r291.editing ? $event.stopPropagation() : undefined; })("blur", function TagComponent_div_2_Template_div_blur_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r289); const ctx_r292 = ɵngcc0.ɵɵnextContext(); return ctx_r292.onBlurred($event); });
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r282.editing)("title", ctx_r282.getDisplayValue(ctx_r282.model));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r282.getDisplayValue(ctx_r282.model), " ");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r282.isDeleteIconVisible());
} }
function TagComponent_tag_ripple_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("state", ctx_r283.rippleState);
...
function TagInputDropdown_ng2_menu_item_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r294 = ɵngcc0.ɵɵnextContext().$implicit;
    const ctx_r297 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("innerHTML", ɵngcc0.ɵɵpipeBind2(1, 1, item_r294[ctx_r297.displayBy], ctx_r297.tagInput.inputForm.value.value), ɵngcc0.ɵɵsanitizeHtml);
} }
...
function TagInputDropdown_ng2_menu_item_2_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r294 = ctx_r301.$implicit;
    const index_r295 = ctx_r301.index;
    const last_r296 = ctx_r301.last;
    const ctx_r298 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r298.templates.first)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction3(2, _c2, item_r294, index_r295, last_r296));
} }
function TagInputDropdown_ng2_menu_item_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("value", item_r294)("ngSwitch", !!ctx_r293.templates.length);
    ɵngcc0.ɵɵadvance(1);
...
function TagInputComponent_tag_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onSelect", function TagInputComponent_tag_2_Template_tag_onSelect_0_listener() { ɵngcc0.ɵɵrestoreView(_r308); const item_r305 = ctx.$implicit; const ctx_r307 = ɵngcc0.ɵɵnextContext(); return ctx_r307.selectItem(item_r305); })("onRemove", function TagInputComponent_tag_2_Template_tag_onRemove_0_listener() { ɵngcc0.ɵɵrestoreView(_r308); const item_r305 = ctx.$implicit; const i_r306 = ctx.index; const ctx_r309 = ɵngcc0.ɵɵnextContext(); return ctx_r309.onRemoveRequested(item_r305, i_r306); })("onKeyDown", function TagInputComponent_tag_2_Template_tag_onKeyDown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r308); const ctx_r310 = ɵngcc0.ɵɵnextContext(); return ctx_r310.handleKeydown($event); })("onTagEdited", function TagInputComponent_tag_2_Template_tag_onTagEdited_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r308); const ctx_r311 = ɵngcc0.ɵɵnextContext(); return ctx_r311.updateEditedTag($event); })("onBlur", function TagInputComponent_tag_2_Template_tag_onBlur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r308); const i_r306 = ctx.index; const ctx_r312 = ɵngcc0.ɵɵnextContext(); return ctx_r312.onTagBlurred($event, i_r306); })("dragstart", function TagInputComponent_tag_2_Template_tag_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r308); const item_r305 = ctx.$implicit; const i_r306 = ctx.index; const ctx_r313 = ɵngcc0.ɵɵnextContext(); return ctx_r313.dragZone ? ctx_r313.onDragStarted($event, item_r305, i_r306) : undefined; })("drop", function TagInputComponent_tag_2_Template_tag_drop_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r308); const i_r306 = ctx.index; const ctx_r314 = ɵngcc0.ɵɵnextContext(); return ctx_r314.dragZone ? ctx_r314.onTagDropped($event, i_r306) : undefined; })("dragenter", function TagInputComponent_tag_2_Template_tag_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r308); const ctx_r315 = ɵngcc0.ɵɵnextContext(); return ctx_r315.dragZone ? ctx_r315.onDragOver($event) : undefined; })("dragover", function TagInputComponent_tag_2_Template_tag_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r308); const i_r306 = ctx.index; const ctx_r316 = ɵngcc0.ɵɵnextContext(); return ctx_r316.dragZone ? ctx_r316.onDragOver($event, i_r306) : undefined; })("dragleave", function TagInputComponent_tag_2_Template_tag_dragleave_0_listener() { ɵngcc0.ɵɵrestoreView(_r308); const ctx_r317 = ɵngcc0.ɵɵnextContext(); return ctx_r317.dragZone ? ctx_r317.dragProvider.onDragEnd() : undefined; });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r305 = ctx.$implicit;
    const i_r306 = ctx.index;
    const ctx_r302 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵpropertyInterpolate("draggable", ctx_r302.editable);
    ɵngcc0.ɵɵproperty("canAddTag", ctx_r302.isTagValid)("disabled", ctx_r302.disable)("@animation", ctx_r302.animationMetadata)("hasRipple", ctx_r302.ripple)("index", i_r306)("removable", ctx_r302.removable)("editable", ctx_r302.editable)("displayBy", ctx_r302.displayBy)("identifyBy", ctx_r302.identifyBy)("template", !!ctx_r302.hasCustomTemplate() ? ctx_r302.templates.first : undefined)("draggable", ctx_r302.dragZone)("model", item_r305);
...
function TagInputComponent_div_6_p_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const error_r319 = ctx.$implicit;
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(error_r319);
} }
function TagInputComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r304.theme);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r304.errors);
} }
const _c3 = ["*"];
