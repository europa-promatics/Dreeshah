...
export class AddressComponent implements OnInit {
  ...
  saveAddress(){
    this.submit_button = true;
      ...
      //console.log(this.addressForm.value.addline1)
      console.log("Value of Fname",this.addressForm.value.fname)
      console.log("Value of lname",this.addressForm.value.lname)
      console.log("Value of aline1",this.addressForm.value.addline1)
      console.log("Value of aline2",this.addressForm.value.addline2)

      console.log("Value of country",this.addressForm.value.country.name)
      console.log("Value of state",this.addressForm.value.state.name)
      console.log("Value of city",this.addressForm.value.city)
      console.log("Value of phone_code",this.countryDial)
      console.log("Value of phone",this.phoneForm.value.phone)

      console.log("Value of pincode",this.addressForm.value.pincode)
      console.log("Value of landmark",this.addressForm.value.area)
      console.log("Value of address_type",this.addressForm.value.addType)

      

  
      var formData = new FormData();
      formData.append('first_name', this.addressForm.value.fname);
      formData.append('last_name', this.addressForm.value.lname);
      ...
      formData.append('state', this.addressForm.value.state.name);
