...
@Component({
  selector: 'app-seller-catalogue-view',
  templateUrl: './seller-catalogue-view.component.html',
  styleUrls: ['./seller-catalogue-view.component.scss']
})
export class SellerCatalogueViewComponent implements OnInit {
