import { Component, OnInit, ChangeDetectionStrategy, Inject, OnDestroy, Renderer2 } from '@angular/core';
...
const data = []
@Component({
  selector: 'app-services-details-new',
  templateUrl: './services-details-new.component.html',
  styleUrls: ['./services-details-new.component.scss']
})
export class ServicesDetailsNewComponent implements OnInit {
  items1: GalleryItem[];
  items2: GalleryItem[];
  service_data
  services_data
  ...
  getServiceDetails() {
    ...
    this.CustomerService.getServiceDetails(obj).subscribe(data => {
      ...
      this.services_data = data.data[0]
